...
sealed class ProductEvent with _$ProductEvent {
  ...
  factory ProductEvent.filterByCategory(String category) =
      FilterByCategoryEvent;
  factory ProductEvent.removeCategoryFromFilter(String category) =
      RemoveCategoryFromFilterEvent;
  factory ProductEvent.searchByKeyWord(String search) = SearchByKeyWordEvent;
  factory ProductEvent.filterByPrice(RangeValues rangeValues) =
      FilterByPriceEvent;
  factory ProductEvent.udpateSelectedProduct(ProductEntity product) =
